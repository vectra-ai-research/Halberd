'''
Module Name: Bruteforce_Graph_API_Tokens
Module Description: Bruteforce Graph API Access Tokens via Delegated Access. Enumerate through different default Azure applications using the supplied credentials to grab access tokens with different scopes.
'''
import requests
import yaml
