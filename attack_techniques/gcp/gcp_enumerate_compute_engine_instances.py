...
class GCPEnumerateComputeEngineInstances(BaseTechnique):
    ...
    def _list_instances (self, location: str, project_id: str, compute_client: compute.InstancesClient, network_tags: list[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            try:
                ...
                with concurrent.futures.ThreadPoolExecutor(max_workers=worker) as executor:
                    results = executor.map(self._list_instances, locations, itertools.repeat(project_id), itertools.repeat(compute_client), itertools.repeat(network_tags) )
                ...
                return ExecutionStatus.FAILURE, {
                    "error": str(e),
                    "message": "Failed to enumerate compute engine instances - Permission denied"
                }
