...
class EntraBruteforceGraphApps(BaseTechnique):
    def __init__(self):
        ...
        super().__init__("Bruteforce Graph Apps - Delegated Access", "Bruteforce through default Azure apps using user credentials to collect access tokens with different scopes", mitre_techniques)
    ...
    def get_parameters(self) -> Dict[str, Dict[str, Any]]:
        return {
            ...
            "save_tokens": {"type": "bool", "required": False, "default":False, "name": "Save Token to App?", "input_field_type" : "bool"}
        }