...
class AWSEnumerateIAMUsers(BaseTechnique):
    def __init__(self):
        ...
        super().__init__("Enumerate IAM Users", "Enumerates all IAM users. Optionally, supply path prefix to enumerate specific users", mitre_techniques)
        ...
        try:
            ...
            if 200 <= raw_response['ResponseMetadata']['HTTPStatusCode'] <300:
                ...
                return ExecutionStatus.SUCCESS, {
                    "message": f"Successfully enumerated {len(users)} users" if users else "No users found",
                    "value": users
                }
